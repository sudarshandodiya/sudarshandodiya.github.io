...
{{< hextra/hero-headline >}}
  Hi, I'm Sudarshan Dodiya<br />Software Developer & Tech Enthusiast
{{< /hextra/hero-headline >}}

<div style="text-align: center; margin: 20px 0;">
  <img src="/image.png" alt="Sudarshan Dodiya Profile Photo" style="width: 200px; height: 200px; border-radius: 50%; object-fit: cover; border: 4px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
</div>

<br />

{{< hextra/hero-subtitle >}}
  Senior Software Engineer specializing in microservices, cloud architecture, and performance optimization.<br />Welcome to my digital space where I share my technical journey and insights.
{{< /hextra/hero-subtitle >}}
